...
#FRITZ PLZ STOP EDITING THIS CAUSE IM WORKING ON IT THX!!!
...
class Speedway(Hood):
    def __init__(self, tp = None):
        self.name = "AREA_SPEEDWAY"
        self.zoneId = 1400
        self.music = "phase_6/audio/bgm/GS_SZ.mid"
        ...
        self.av_startposBAD = (
                            ((26.9633, 191.896, 6.66862),(-464.669, 0, 0)),
                            ((87.6961, 196.579, 6.66758),(-574.525, 0, 0)),
                            ((58.5116, 236.732, 6.99299),(-738.809, 0, 0)),
                            ((6.39003, 274.927, 6.29251),(-735.2, 0, 0)),
                            ((12.6199, 295.065, 6.29251),(-794.28, 0, 0)),
                            ((43.4161, 335.746, 6.26027),(-800.701, 0, 0)),
                            ((73.4399, 343.117, 6.26027),(-918.486, 0, 0)),
                            ((108.981, 303.644, 6.28365),(-857.753, 0, 0)),
                            ((108.131, 278.627, 6.2788),(-960.965, 0, 0)),
                            ((57.9075, 254.002, 6.9893),(-901.178, 0, 0))
                            )
        ...
        Tunnel(self.tun,BitMask32(8),self,(TTCentral,'AREA_TTC'))
...
class AcornAcres(Hood):
    def __init__(self,tp=None):
        self.music = "phase_6/audio/bgm/OZ_SZ.mid"
        self.name = "AREA_ACRES"
        self.zoneId = 2400
        
        self.av_startpos = (
                            ((-39.4676, -236.446, 0.159306),(-395.561, 0, 0)),
                            ((-23.0442, -198.471, 0.991364),(-362.976, 0, 0)),
                            ((15.9029, -139.908, 4.69807),(-567.076, 0, 0)),
                            ((-4.88025, -53.0072, 0.446336),(-617.6, 0, 0)),
                            ((-28.3566, -71.185, 0.878941),(-575.218, 0, 0)),
                            ((47.8006, -197.265, 0.796633),(-555.24, 0, 0)),
                            ((124.024, -218.697, -0.00388891),(-615.604, 0, 0)),
                            ((127.492, -211.356, -0.00388891),(-500.505, 0, 0)),
                            ((104.932, -257.61, -0.0332635),(-585.385, 0, 0)),
                            ((-74.0625, -311.529, -0.00394408),(-615.523, 0, 0)),
                            )
        ...
        Tunnel(self.toG,BitMask32(8),self,(MiniGolfZone,'AREA_MINIGOLF'))
...
class MiniGolfZone(Hood):
    def __init__(self,tp=None):
        self.music = "phase_6/audio/bgm/GZ_SZ.mid"
        self.name = "AREA_MINIGOLF"
        self.zoneId = 2450
        ...
        Tunnel(self.toB,BitMask32(8),self,(BossbotHQ,'AREA_HQ_BOSS'))
        ...
        Tunnel(self.toAA,BitMask32(8),self,(AcornAcres,'AREA_ACRES'))
