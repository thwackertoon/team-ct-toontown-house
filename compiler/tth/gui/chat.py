...
class ClassicChatBox:
 
    def __sendChat__(self, message):
 
        blacklist = ["fuck", "ass", "shit", "piss", "fawk", "nigger", "nigga", "retarded", \
                     "retard", "bitch", "fuk", "asshole", "fucker", "shitter", "fucks", "shits", "asses", \
                     "dumbfuck", "dumbass", "cock", "damnit", "pussy", "motherfucker"]
        
        blacklist.extend(["foda", "cu", "merda", "piss", "fawk", "nigger", "nigga", "retardado", \
                          "idiota", "puta", "fude", "anal", "fucker", "shitter", "fucks", "shits", "asses", \
                          "dumbfuck", "dumbass", "pau", "pinto", "buceta", "motherfucker"]) #portuguese words
        
        filteredMsg = message.lower()
        for blackitem in blacklist:
            if blackitem.lower() in message:
                filteredMsg = message.replace(blackitem.lower(),'***')
        
        t = gamebase.curArea.toon
        t.b_speak(filteredMsg)
    ...
    def __addNavs__(self):
        ...
        self.OldChatBoxGui = DirectFrame(parent = self.frame, pos=(-0.18-.15, 0,0.901), scale=1, frameSize=(0,0,0,0), image=self.ChatBox.find("**/quick_talker"))
    ...
    def __addOnButton__(self):
        ...
        #self.OldChatBoxOpen.wrtReparentTo(base.a2dTopLeft)
